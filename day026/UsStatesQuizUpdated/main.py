...
data = pandas.read_csv("UsStatesQuiz/50_states.csv")
...
while len(guessed_states) < 50:
    ...
    if answer_state == "Exit":
        missing_states = [state for state in all_states if state not in guessed_states] #Simplified using list comprehension
        # missing_states = []
